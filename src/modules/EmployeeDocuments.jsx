...
const onSubmit = async (data) => {
  ...
  //   { key: "photo", label: "Photo", render: v => v && <img src={v} className="h-24 rounded border" /> },
  //   { key: "aadhar_front", label: "Aadhar Front", render: v => v && <img src={v} className="h-24 rounded border" /> },
  //   { key: "aadhar_back", label: "Aadhar Back", render: v => v && <img src={v} className="h-24 rounded border" /> },
  //   { key: "pan_card", label: "PAN Card", render: v => v && <img src={v} className="h-24 rounded border" /> },
