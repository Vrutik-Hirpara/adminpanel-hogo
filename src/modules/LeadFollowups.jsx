...
//             {/* <span className="cursor-pointer text-lg transition-all duration-200 hover:scale-125 hover:text-blue-400" > */}
//             <span
      ...
      render: (row) =>
        row.notes ? (
          <div className="relative group flex justify-center">
            ...
            <div
              className="absolute hidden group-hover:block z-50 text-xs rounded-lg px-3 py-2 w-48 break-words shadow-xl top-7 left-1/2 -translate-x-1/2 -translate-y-full"
              style={{
