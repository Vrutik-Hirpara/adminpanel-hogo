  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-6 mb-4">
      ...
      <button
        ...
        className={`p-2 rounded-lg transition-all duration-300 flex items-center justify-center ${currentPage === 1
      ...
      <button
        ...
        className={`p-2 rounded-lg transition-all duration-300 flex items-center justify-center ${currentPage === totalPages
            ? "opacity-40 cursor-not-allowed"
            : "hover:bg-gray-100 active:scale-95"
          }`}
        style={{ color: themes.textPrimary }}
